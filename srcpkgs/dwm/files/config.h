...
static const char col_blue[]        = "#5bb5ff";
...
static const char *sleeplight[] = { "sudo", "zzz", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,               57,    nametag,        {0} },                // n
	{ 0,                   121,    spawn,          {.v = mute } },       // F1
	{ 0,                   122,    spawn,          {.v = downvol } },    // F2
	{ 0,                   123,    spawn,          {.v = upvol } },      // F3
	{ 0,                   232,    spawn,          {.v = downbright } }, // F5
	{ 0,                   233,    spawn,          {.v = upbright } },   // F6
	{ 0,                   151,    spawn,          {.v = sleeplight } }, // closing lid
	TAGKEYS(                10,                    0)                    // 1
	TAGKEYS(                11,                    1)                    // 2
	TAGKEYS(                12,                    2)                    // 3
	TAGKEYS(                13,                    3)                    // 4
